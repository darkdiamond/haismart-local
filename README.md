...
[![Release](https://img.shields.io/github/v/release/darkdiamond/haismart-local?color=green)](https://github.com/darkdiamond/haismart-local/releases/latest)
[![Validate](https://img.shields.io/github/actions/workflow/status/darkdiamond/haismart-local/validate.yml?branch=main&label=validate)](https://github.com/darkdiamond/haismart-local/actions/workflows/validate.yml)
[![License](https://img.shields.io/github/license/darkdiamond/haismart-local)](LICENSE)
...
1. Open this repository in HACS:\
   [![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=darkdiamond&repository=haismart-local&category=integration)
...
1. Repository: `https://github.com/darkdiamond/haismart-local`, type **Integration** → **Add**.
...
1. Download the source of the [latest release](https://github.com/darkdiamond/haismart-local/releases/latest).
...
1. Search [existing issues](https://github.com/darkdiamond/haismart-local/issues?q=is%3Aissue),
...
This is a fork of **[enapt/haismart-local](https://github.com/enapt/haismart-local)** — enormous
thanks to [**@enapt**](https://github.com/enapt), who reverse-engineered the uSS/HRDP local protocol
and wrote the original integration. Essentially all the hard work of figuring out how these units
speak is theirs, and they remain in `codeowners`. This fork exists only because pull requests are
disabled on the upstream repository, so improvements couldn't be contributed back.
